...
# use if just want to look at one neighborhood: for (neighborhood in c("Portland, OR - Rose City Park")){
  ...
  # Seasonal Naive
  print("Seasonal Naive Accuracy for ", neighborhood)
  summary(snaive.accuracy)
  
  # Holt Winters
  print("Holt Winters Accuracy for ", neighborhood)
  hwinters.accuracy
  ...
  plotTitle <- paste(neighborhood, ": TS Training Model Analysis Comparison")
  options(scipen=999)
  ...
  # This needs work  ********************
  # Forecast plot for Combined models ---------
  plotTitle <- paste(neighborhood, ": TS Full Neighborhood Models Analysis Comparison")
  options(scipen=999)
  # plots both the train data, test data and both predictions
  plot(hwinters.full.forecast$mean, main=plotTitle, ylab = "Median House Price", xlab = "Year", xlim=c(2012, 2020)) # change the x axis on this
  lines(oneNeighborhood.timeseries,col="blue", lty="dashed")
