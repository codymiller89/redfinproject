...
```
## Appendix A: Data Analysis of Neighborhoods
...
Load all of the redfin data into the data frame.  We will only be using median price in the timeseries, but this is interesting data that was analyzed prior to deciding on the final solution. 
```{r load-filter-data}
...
```
Print out some variables in the dataset. We will only be using median price in the timeseries, but this is interesting data that was analyzed prior to deciding on the final solution. 
```{r}
