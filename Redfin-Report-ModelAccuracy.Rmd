...
Auto Correlation Function (ACF) is a way give correlations between the series at lagged values of the series (seasonality). None of the corrlations look significant, which is what we want. 
