## Accuracy Evaluation
For this evaluation we will use one of the neighborhoods: Lents. 
The neighborhood will be selected and each of the models will be trained against the Lents training set. 
...
```
For this project week looked at the following types of models: naive, seasonal naive, drift and Holt Winters. 
We run each of these models against the training set. 
...
For accurate forecasting, we have chosen Holt Winters as the most accurate model, for this neighborhood as well as a random sampling of others in the set of neighborhoods. 
